...
var url="https://erfreewifi.com/api/session?filter=%7B%22username%22%3A%22"+_mac+"%22%7D&sort=-id&offset=0&limit=1&calculate_count=true"
...
/*if(currentDate.getFullYear()==2022 && currentDate.getMonth()+1==1 && currentDate.getDate()==11 && ((currentDate.getHours()>=17 && currentDate.getMinutes()>58) 
||(currentDate.getHours()>17 && currentDate.getHours()<20)))
{var seconds = 120;
}
else{*/
	var seconds = 60;
